...
<section id="sub1" class="content">
    <div class="title">
        <div>캠핑장소개</div>
        <h2>서브페이지 <span>캠핑장소개</span></h2>
    </div>

    <img src="./resources/imgs/make/information.jpg" alt="" id="sub1-img">
...
<section id="sub2">
    <div id="sub2-container" class="content">
        <div class="title">
            <div>캠핑장 이용수칙</div>
            <h2>서브페이지 <span>캠핑장 이용수칙</span></h2>
        </div>
        ...
        <div id="sub2-main">
            ...
            <div class="sub2-info">
                ...
                <div>홍보</div>
                <div>
                    <div>캠핑장내에서 정치적 또는 종교적인 홍보 등은 금지되어 있습니다.</div>
                    <div>관리자의 사전허가 없이는 상업적인 홍보 또는 물품의 판매를 할 수 없습니다.</div>
                </div>
            </div>
            <div class="sub2-info">
                <i class="fa-solid fa-thumbtack"></i>
...
<section id="sub3" class="content between">
    <div class="title">
        <div>시설배치도</div>
        <h2>서브페이지 <span>시설배치도</span></h2>
    </div>
    <img src="./resources/imgs/make/sub3.jpg" alt="img" title="img" id="sub3-img">
</section>
